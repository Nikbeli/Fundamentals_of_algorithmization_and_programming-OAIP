...
void LoadLines() {
	...
	FILE* fin = fopen("C:\\Users\\Никита\\source\\repos\\Program create\\ULSTU\\Lab26\\Txt\\lines1.txt", "rt");
	if (fin == NULL) {
	...
	fin = fopen("C:\\Users\\Никита\\source\\repos\\Program create\\ULSTU\\Lab26\\Txt\\lines1.txt", "rt");
	if (lines != NULL) {
		free(lines);
	}
	n = num;
