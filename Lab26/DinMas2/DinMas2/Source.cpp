...
void Load() {
	...
	FILE* fin = fopen("C:\\Users\\Никита\\source\\repos\\Program create\\ULSTU\\Lab26\\Txt\\in2.txt", "rt");
	if (fin == NULL) {
...
void SaveResult() {
	...
	FILE* fout = fopen("C:\\Users\\Никита\\source\\repos\\Program create\\ULSTU\\Lab26\\Txt\\out2.txt", "wt");
	if (fout == NULL) {
